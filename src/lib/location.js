...
export const municipiosPorEstado = {
  MA: [
    'Açailândia', 'Imperatriz', 'João Lisboa', 'Estreito', 'Porto Franco', 'Grajaú', 'Barra do Corda', 'Presidente Dutra', 'Tuntum', 'São Domingos do Maranhão', 'Colinas', 'Mirador', 'Sucupira do Norte', 'Pastos Bons', 'Paraibano', 'São João dos Patos', 'Passagem Franca', 'Buriti Bravo', 'Fortuna', 'São Raimundo das Mangabeiras', 'Sambaíba', 'Loreto', 'Balsas', 'Riachão', 'Tasso Fragoso', 'Alto Parnaíba', 'Carolina', 'Feira Nova do Maranhão', 'São Pedro dos Crentes', 'Formosa da Serra Negra', 'Itaipava do Grajaú', 'Jenipapo dos Vieiras', 'Arame', 'Amarante do Maranhão', 'Montes Altos', 'Sítio Novo', 'Davinópolis', 'Governador Edison Lobão', 'Ribamar Fiquene', 'Campestre do Maranhão', 'Lajeado Novo', 'São Francisco do Brejão', 'Cidelândia', 'Vila Nova dos Martírios', 'São Pedro da Água Branca', 'Senador La Rocque', 'Buritirana'
  ],
  PA: [
