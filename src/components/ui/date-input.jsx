...
export function DateInput({ date, setDate, className, ...props }) {
  ...
  return (
    <div className={cn("relative w-full", className)}>
      <Input
        ...
        className="pr-10 rounded-xl bg-white/20 border-white/30 text-white placeholder:text-white/60 focus:ring-emerald-400"
        {...props}
      />
