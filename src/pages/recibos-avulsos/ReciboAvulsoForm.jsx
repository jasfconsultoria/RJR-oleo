    ...
    try {
      ...
      if (data) {
        setFormData({
          ...
          pessoa_municipio: data.pessoa_municipio || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const reciboData = {
        ...
        valor: valorNumerico,
        data_recibo: formData.data_recibo.toISOString().split('T')[0],
              ...
              <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                ...
                <div className="md:col-span-3">
                  ...
                  <IMaskInput
                    ...
                    onAccept={(value) => handleInputChange('valor', value || '0,00')}
                    placeholder="0,00"
                    className="w-full flex h-9 rounded-xl border border-white/20 bg-white/5 px-3 py-1 text-xs ring-offset-background file:border-0 file:bg-transparent file:text-xs file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                    required
                    inputMode="decimal"
                  />
                </div>
