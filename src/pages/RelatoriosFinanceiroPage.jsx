...
import { Loader2, Search, DollarSign, Eye, Receipt, Banknote, Tag, ClipboardList, CalendarIcon, ChevronUp, ChevronDown } from 'lucide-react';
...
const RelatoriosFinanceiroPage = () => {
  ...
  const fetchEntries = useCallback(async () => {
    ...
    setLoading(false);
  }, [toast, currentPage, pageSize, reportType, debouncedSearchTerm, debouncedClientSearchTerm, statusFilter, debouncedStartDate, debouncedEndDate, empresa, title]);
  ...
  }, [reportType, statusFilter, debouncedStartDate, debouncedEndDate, empresa, debouncedSearchTerm, debouncedClientSearchTerm]);
  ...
  return (
    <>
      <Helmet><title>{title} - RJR Óleo</title></Helmet>
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-white flex items-center gap-2">
                <DollarSign className="w-8 h-8 text-emerald-400" /> {title}
            </h1>
            <p className="text-emerald-200/80 mt-1">Visualize e filtre os lançamentos financeiros.</p>
          </div>
                            ...
                            <TooltipProvider>
                              <div className="flex justify-end items-center gap-1">
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <Button 
                                      ...
                                      onClick={() => toast({ title: 'Funcionalidade em desenvolvimento', description: 'O registro de pagamento será implementado em breve.', variant: 'default' })} 
                                ...
                                <Button 
                                  ...
                                  onClick={() => toast({ title: 'Funcionalidade em desenvolvimento', description: 'O histórico de pagamentos será implementado em breve.', variant: 'default' })}
                                >
                                ...
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <Button 
                                      ...
                                      onClick={() => toast({ title: 'Funcionalidade em desenvolvimento', description: 'A edição de lançamentos será implementada em breve.', variant: 'default' })}
                                ...
                                <AlertDialog>
                                  ...
                                  <AlertDialogContent className="bg-emerald-900 border-emerald-700 text-white rounded-xl">
                                    ...
                                    <AlertDialogFooter>
                                      ...
                                      <AlertDialogAction onClick={() => toast({ title: 'Funcionalidade em desenvolvimento', description: 'A exclusão de lançamentos será implementada em breve.', variant: 'default' })} className="bg-red-500 hover:bg-red-600 rounded-xl">Deletar</AlertDialogAction>
                                    </AlertDialogFooter>
                                  </AlertDialogContent>
                                </AlertDialog>
                              </div>
