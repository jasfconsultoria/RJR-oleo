                                ...
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <Button
                                      ...
                                      onClick={() => !isVinculadaColeta && navigate(`/app/estoque/entradas/editar/${mov.id}`)}
                                  ...
                                  <TooltipContent className="bg-gray-800 text-white border-gray-700 rounded-xl">
                                    <p>{isVinculadaColeta ? "Entradas de coletas devem ser editadas na coleta de origem." : "Editar entrada"}</p>
                                  </TooltipContent>
                                </Tooltip>
                                    ...
                                    <AlertDialogContent className="bg-emerald-900 border-emerald-700 text-white rounded-xl">
                                      <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription className="text-emerald-300">
                                          Essa ação não pode ser desfeita. Isso deletará permanentemente a entrada de estoque.
