                                ...
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <Button
                                      ...
                                      onClick={() => !isVinculadaColeta && navigate(`/app/estoque/saidas/editar/${mov.id}`)}
                                  ...
                                  <TooltipContent className="bg-gray-800 text-white border-gray-700 rounded-xl">
                                    <p>{isVinculadaColeta ? "Saídas de coletas devem ser editadas na coleta de origem." : "Editar saída"}</p>
                                  </TooltipContent>
                                </Tooltip>
                                    ...
                                    <AlertDialogContent className="bg-emerald-900 border-emerald-700 text-white rounded-xl">
                                      <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription className="text-emerald-300">
                                          Essa ação não pode ser desfeita. Isso deletará permanentemente a saída de estoque.
