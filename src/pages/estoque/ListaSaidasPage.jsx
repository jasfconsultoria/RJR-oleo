                      ...
                      <TableRow key={mov.id} className="border-b-0 md:border-b border-white/10 text-white/90 hover:bg-white/5 text-sm">
                        ...
                        <TableCell className="text-right actions-cell">
                           <div className="flex justify-end items-center gap-2">
                            ...
                            <Button variant="ghost" size="icon" className="text-yellow-400 hover:text-yellow-300 rounded-xl" onClick={() => navigate(`/app/estoque/saidas/editar/${mov.id}`)}><Edit className="h-4 w-4" /></Button>
                            <AlertDialog>
