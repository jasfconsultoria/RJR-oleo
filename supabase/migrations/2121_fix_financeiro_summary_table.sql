-- 2121_fix_financeiro_summary_table.sql
-- Description: Retorna a RPC de resumo financeiro para o formato de tabela para garantir compatibilidade com o frontend e resolve o tipo de retorno.
...
BEGIN
    ...
    SELECT
        ...
        COALESCE(SUM(cd.discount), 0)::numeric,
